       ...
       try:
           if call.data == "start_new":
               ...
               retry_send_message(
                   bot.send_message,
                   call.message.chat.id,
                   f"Share AnzaBiz AI with friends! Invite 3 friends to @AnzaBiz_bot and get a free KES 100 summary. Visit https://www.linkedin.com/in/mwaura-wambiru/ for details."
               )
           else:
               retry_send_message(
                   bot.send_message,
